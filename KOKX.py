...
# -*- coding: utf-8 -*-
"""
Created on Tue Nov 17 18:07:21 2020
...
file_zh = 'KOKX_N0R_20160123_120600._Zhnc'
file_zdr = 'KOKX_N0X_20160123_120600_Zdr.nc'
...
xlim = np.array([-76,-70]); ylim = np.array([38.5,43])
...
plt.title(r'KOKX 1/23 1206 UTC $Z_{H}$', size = title_font_size)
plt.show()
...
plt.title(r'KOKX 1/23 1206 UTC $Z_{DR}$', size = title_font_size)
plt.show()
