...
# -*- coding: utf-8 -*-
"""
Created on Mon Nov  9 17:36:07 2020
...
# -*- coding: utf-8 -*-
"""
Created on Tue Nov  3 15:59:26 2020
...
file_zh = 'KCLE_N0R_20171214_025600_Zh.nc'
file_zdr = 'KCLE_N0X_20171214_025600_Zdr.nc'
...
xlim = np.array([-84.,-80]); ylim = np.array([40,43])
...
plt.title(r'KCLE 12/14 0256 UTC $Z_{H}$', size = title_font_size)
plt.show()
...
plt.title(r'KCLE 12/14 0256 UTC $Z_{DR}$', size = title_font_size)
plt.show()
