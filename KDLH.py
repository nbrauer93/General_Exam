...
# -*- coding: utf-8 -*-
"""
Created on Thu Nov 19 20:16:41 2020
...
file_zh = 'KDLH_N0R_20141111_053300_Zh.nc'
file_zdr = 'KDLH_N0X_20141111_053300_Zdr.nc'
...
xlim = np.array([-95,-89.5]); ylim = np.array([44.5,49])
...
plt.title(r'KDLH 11/11 0532 UTC $Z_{H}$', size = title_font_size)
plt.show()
...
plt.title(r'KDLH 11/11 0532 UTC $Z_{DR}$', size = title_font_size)
plt.show()
