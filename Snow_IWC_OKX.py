...
# -*- coding: utf-8 -*-
"""
Created on Fri Nov 13 17:01:31 2020
...
file = 'GRtoDPR.KOKX.160123.10811.V06A.KU.NS.1_21.nc.gz'

file_ka = 'GRtoDPR.KOKX.160123.10811.V06A.KA.HS.1_21.nc.gz'
...
plt.title(r'KOKX $0.5^{o}$ $Z_{H}$ 1/23/2016',name='Calibri',size=26)
...
plt.xticks(size = tick_label_size)
plt.yticks(size = tick_label_size)
plt.title(r'KOKX $0.5^{o}$ $log_{10}(N_{w})$ 1/23/2016',name='Calibri',size=26)
...
plt.xticks(size = tick_label_size)
plt.yticks(size = tick_label_size)
plt.title(r'KOKX $0.5^{o}$ $D_{m}$ 1/23/2016',name='Calibri',size=26)
...
plt.xticks(size = tick_label_size)
plt.yticks(size = tick_label_size)
plt.title(r'KOKX S($Z_{H}$, $K_{DP}$) 1/23/2016 ',name='Calibri',size=26)
...
plt.xticks(size = tick_label_size)
plt.yticks(size = tick_label_size)
plt.title(r'KOKX IWC($Z_{H}$, $K_{DP}$) 1/23/2016',name='Calibri',size=26)
...
plt.xticks(size = tick_label_size)
plt.yticks(size = tick_label_size)
plt.title(r'KOKX S($Z_{H}$) 1/23/2016',name='Calibri',size=26)
...
plt.xticks(size = tick_label_size)
plt.yticks(size = tick_label_size)
plt.title(r'KOKX S(KuPR)1/23/2016',name='Calibri',size=26)
...
plt.xticks(size = tick_label_size)
plt.yticks(size = tick_label_size)
plt.title(r'KOKX S(KaPR) 1/23/2016 ',name='Calibri',size=26)
...
plt.xticks(size = tick_label_size)
plt.yticks(size = tick_label_size)
plt.title(r'KOKX $0.5^{o}$ Reflectivity Bias 1/23/2016',name='Calibri',size=26)
