...
file = 'GRtoDPR.KBUF.180302.22768.V06A.KU.NS.1_21.nc.gz'

file_ka = 'GRtoDPR.KBUF.180302.22768.V06A.KA.HS.1_21.nc.gz'
...
plt.title(r'KBUF $0.5^{o}$ $Z_{H}$ 3/2/2018',name='Calibri',size=26)
...
plt.xticks(size = tick_label_size)
plt.yticks(size = tick_label_size)
plt.title(r'KBUF $0.5^{o}$ $log_{10}(N_{w})$ 3/2/2018',name='Calibri',size=26)
...
plt.xticks(size = tick_label_size)
plt.yticks(size = tick_label_size)
plt.title(r'KBUF $0.5^{o}$ $D_{m}$ 3/2/2018',name='Calibri',size=26)
...
plt.xticks(size = tick_label_size)
plt.yticks(size = tick_label_size)
plt.title(r'KBUF S($Z_{H}$, $K_{DP}$) 3/2/2018 ',name='Calibri',size=26)
...
plt.xticks(size = tick_label_size)
plt.yticks(size = tick_label_size)
plt.title(r'KBUF IWC($Z_{H}$, $K_{DP}$) 3/2/2018',name='Calibri',size=26)
...
plt.xticks(size = tick_label_size)
plt.yticks(size = tick_label_size)
plt.title(r'KBUF S($Z_{H}$) 3/2/2018 ',name='Calibri',size=26)
...
plt.xticks(size = tick_label_size)
plt.yticks(size = tick_label_size)
plt.title(r'KBUF S(KuPR) 3/2/2018 ',name='Calibri',size=26)
...
plt.xticks(size = tick_label_size)
plt.yticks(size = tick_label_size)
plt.title(r'KBUF S(KaPR) 3/2/2018 ',name='Calibri',size=26)
...
plt.xticks(size = tick_label_size)
plt.yticks(size = tick_label_size)
plt.title(r'KBUF $0.5^{o}$ Reflectivity Bias 3/2/2018',name='Calibri',size=26)
