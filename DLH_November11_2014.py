...
# -*- coding: utf-8 -*-
"""
Created on Thu Nov 19 20:00:56 2020
...
file = 'GRtoDPR.KDLH.141111.3992.V06A.DPR.HS.1_21.nc.gz'

#file_ka = 'GRtoDPR.KDLH.141111.3992.V06A.DPR.HS.1_21.nc'



nc = open_netcdf(file)
#nc_ka = open_netcdf(file_ka)
...
#For the Ka-band file


#latitude_ka = nc_ka.variables['latitude'][:]
#longitude_ka = nc_ka.variables['longitude'][:]
#z_ka = nc_ka.variables['ZFactorCorrected'][:]

#Take only the inner swath of the Ku-band data
ku_ka_matchup = z[:,172:1070]
...
ku_ka_matchup[ku_ka_matchup<=0] = np.nan
#z_ka[z_ka<=0] = np.nan
z[z<=0] = np.nan
...
ku_ka_lowest = ku_ka_matchup[elev_angle,:]
#z_ka_lowest = z_ka[elev_angle,:]
...
#Now compute S(Z), S(KuPR), and S(KaPR) using Z = 120S^2


snow_z = np.sqrt(gr_z[elev_angle,:]/120)
snow_ku = np.sqrt(z_lowest/120)
#snow_ka = np.sqrt(z_ka_lowest/120)
...
for i in range(len(s_kdp_z_lowest)):
    ...
    if s_kdp_z_lowest[i]<=0.5:
        #z_color[i] = colormap[0]
        snowfall_color.append(dm_colormap[0])
    
    elif s_kdp_z_lowest[i]>0.5 and s_kdp_z_lowest[i]<=0.75:
        #z_color[i] = colormap[1]
        snowfall_color.append(dm_colormap[1])
    
    elif s_kdp_z_lowest[i]>0.75 and s_kdp_z_lowest[i]<=1.0:
        #z_color[i] = colormap[2]
        snowfall_color.append(dm_colormap[2])
    
    elif s_kdp_z_lowest[i]>1.0 and s_kdp_z_lowest[i]<=1.25:
        #z_color[i] = colormap[3]
        snowfall_color.append(dm_colormap[3])
    
    elif s_kdp_z_lowest[i]>1.25 and s_kdp_z_lowest[i]<=1.5:
        #z_color[i] = colormap[4]
        snowfall_color.append(dm_colormap[4])
    
    elif s_kdp_z_lowest[i]>1.5 and s_kdp_z_lowest[i]<=1.75:
        #z_color[i] = colormap[5]
        snowfall_color.append(dm_colormap[5])
        
    elif s_kdp_z_lowest[i]>1.75 and s_kdp_z_lowest[i]<=2.0:
        #z_color[i] = colormap[6]
        snowfall_color.append(dm_colormap[6])
    
    elif s_kdp_z_lowest[i]>2.0 and s_kdp_z_lowest[i]<=2.25:
        #z_color[i] = colormap[7]
        snowfall_color.append(dm_colormap[7])
        
    elif s_kdp_z_lowest[i]>2.25 and s_kdp_z_lowest[i]<=2.5:
        #z_color[i] = colormap[8]
        snowfall_color.append(dm_colormap[8])
        
    elif s_kdp_z_lowest[i]>2.5 and s_kdp_z_lowest[i]<=2.75:
        
        snowfall_color.append(dm_colormap[9])
        
    elif s_kdp_z_lowest[i]>2.75 and s_kdp_z_lowest[i]<=3.0:
        
        snowfall_color.append(dm_colormap[10])
        
    elif s_kdp_z_lowest[i]>3.0 and s_kdp_z_lowest[i]<=3.25:
        
        snowfall_color.append(dm_colormap[11])
        
    elif s_kdp_z_lowest[i]>3.25 and s_kdp_z_lowest[i]<=3.5:
        
        snowfall_color.append(dm_colormap[12])       
        
    elif s_kdp_z_lowest[i]>3.5 and s_kdp_z_lowest[i]<=3.75:
        
        snowfall_color.append(dm_colormap[13])
        
    elif s_kdp_z_lowest[i]>3.75 and s_kdp_z_lowest[i]<=4.0:
...
for i in range(len(snow_ka)):

    if snow_ka[i]<=0.3:
        #z_color[i] = colormap[0]
        snowfall_color_ka.append(dm_colormap[0])
    
    elif snow_ka[i]>0.3 and snow_ka[i]<=0.4:
        #z_color[i] = colormap[1]
        snowfall_color_ka.append(dm_colormap[1])
    
    elif snow_ka[i]>0.4 and snow_ka[i]<=0.5:
        #z_color[i] = colormap[2]
        snowfall_color_ka.append(dm_colormap[2])
    
    elif snow_ka[i]>0.5 and snow_ka[i]<=0.6:
        #z_color[i] = colormap[3]
        snowfall_color_ka.append(dm_colormap[3])
    
    elif snow_ka[i]>0.6 and snow_ka[i]<=0.7:
        #z_color[i] = colormap[4]
        snowfall_color_ka.append(dm_colormap[4])
    
    elif snow_ka[i]>0.7 and snow_ka[i]<=0.8:
        #z_color[i] = colormap[5]
        snowfall_color_ka.append(dm_colormap[5])
        
    elif snow_ka[i]>0.8 and snow_ka[i]<=0.9:
        #z_color[i] = colormap[6]
        snowfall_color_ka.append(dm_colormap[6])
    
    elif snow_ka[i]>0.9 and snow_ka[i]<=1.:
        #z_color[i] = colormap[7]
        snowfall_color_ka.append(dm_colormap[7])
        
    elif snow_ka[i]>1. and snow_ka[i]<=1.5:
        #z_color[i] = colormap[8]
        snowfall_color_ka.append(dm_colormap[8])
        
    elif snow_ka[i]>1.5 and snow_ka[i]<=2.:
        
        snowfall_color_ka.append(dm_colormap[9])
        
    elif snow_ka[i]>2. and snow_ka[i]<=2.5:
        
        snowfall_color_ka.append(dm_colormap[10])
        
    elif snow_ka[i]>2.5 and snow_ka[i]<=3.:
        
        snowfall_color_ka.append(dm_colormap[11])
        
    elif snow_ka[i]>3. and snow_ka[i]<=3.5:
        
        snowfall_color_ka.append(dm_colormap[12])       
        
    elif snow_ka[i]>3.5 and snow_ka[i]<=4.:
        
        snowfall_color_ka.append(dm_colormap[13])
        
    elif snow_ka[i]>4. and snow_ka[i]<=4.5:
        
        snowfall_color_ka.append(dm_colormap[14])        
...
plt.title(r'KDLH $0.5^{o}$ $Z_{H}$ 11/11/2014',name='Calibri',size=26)
...
plt.xticks(size = tick_label_size)
plt.yticks(size = tick_label_size)
plt.title(r'KDLH $0.5^{o}$ $log_{10}(N_{w})$ 11/11/2014',name='Calibri',size=26)
...
plt.xticks(size = tick_label_size)
plt.yticks(size = tick_label_size)
plt.title(r'KDLH $0.5^{o}$ $D_{m}$ 11/11/2014',name='Calibri',size=26)
...
plt.xticks(size = tick_label_size)
plt.yticks(size = tick_label_size)
plt.title(r'KDLH S($Z_{H}$, $K_{DP}$) 11/11/2014 ',name='Calibri',size=26)
...
plt.xticks(size = tick_label_size)
plt.yticks(size = tick_label_size)
plt.title(r'KDLH IWC($Z_{H}$, $K_{DP}$) 11/11/2014',name='Calibri',size=26)
...
plt.xticks(size = tick_label_size)
plt.yticks(size = tick_label_size)
plt.title(r'KDLH S($Z_{H}$) 11/11/2014',name='Calibri',size=26)
...
plt.xticks(size = tick_label_size)
plt.yticks(size = tick_label_size)
plt.title(r'KDLH S(KuPR) 11/11/2014',name='Calibri',size=26)
...
scalar_mappable_object = plt.cm.ScalarMappable(cmap=cmap, norm=colour_norm_object)
scalar_mappable_object.set_array(snowfall_color_ka)

figure_object, axes_object = plt.subplots(1, 1, figsize=(10, 10))

c = plt.scatter(longitude_ka[:, elev_angle], latitude_ka[:, elev_angle], c = snowfall_color_ka, vmin = 0., vmax = 4., cmap = cmap_dm, edgecolors = 'none')


for i in range(len(snowfall_color_ka)):
        if snowfall_color_ka[i] ==0: 
            c2 = plt.scatter(longitude_ka[i,elev_angle], latitude_ka[i,elev_angle], edgecolors = 'k', facecolors = 'none')
...
plt.xticks(size = tick_label_size)
plt.yticks(size = tick_label_size)
plt.title(r'KDLH S(KaPR) 11/11/2014 ',name='Calibri',size=26)
...
plt.xticks(size = tick_label_size)
plt.yticks(size = tick_label_size)
plt.title(r'KDLH $0.5^{o}$ Reflectivity Bias 11/11/2014',name='Calibri',size=26)
