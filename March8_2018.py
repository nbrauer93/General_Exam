...
file = '2A.GPM.DPR.V8-20180723.20180308-S014524-E031759.022860.V06A.HDF5'
...
ind1 = np.where((lon[:,0]>=-75.5)) #Where are the DPR lons >= -100
...
#Compute echo top height in the along-track direction

echo_top_index = np.array([16,17,20,17,21,23,32,23,23,32,38,35,35,35,42,42,43,40,42,41,35,38,32,34,37,35,35,36,43,39,38,39,37,38,39,42,41,41,37,41,35,41,37,37,17,44,26,22,34,35,22,32,31,21,23,32,32,25,22,30,27,34,31,25,26,26,25,24,24,26,24,24,26,24,25,21,22,24,24,24,22,22,22,23,24,24,20,20,23,24,23,24,21,24,])
...
plt.title('3/8/2018 Along-Track Echo Top Height', fontsize = 18)
...
plt.title('New England 3/8/2018 Along-Track KuPR', size = title_size)
...
plt.title(r'GPM Overpass 3/8/2018 $D_{M}$ ', size = 20)
...
plt.xlabel('Along Track Distance (km)', size = 20)
plt.ylabel('Altitude (km)', size = 20)
plt.title(r'GPM Overpass 3/8/2018 $log_{10 }(N_{W})$ ', size = 20)
plt.xlim(dist[0],dist[1])
plt.ylim(altitude[0],altitude[1])
cbar = plt.colorbar()
cbar.ax.tick_params(labelsize = label_size)
...
plt.xlabel('Along Track Distance (km)', size = 20)
plt.ylabel('Altitude (km)', size = 20)
plt.title(r'GPM Overpass 3/8/2018 KuPR ', size = 20)
#plt.xlim(300,450)
plt.xlim(dist[0], dist[1])
plt.ylim(altitude[0],altitude[1])
cbar = plt.colorbar()
...
xlim = np.array([-74,-69]); ylim = np.array([40,46])
...
plt.title('GPM Overpass 3/8/2018 KuPR', size = 20)

label = 'KBOX'
x2star,y2star = m(-71.137,41.956)
...
plt.title('GPM Overpass 3/8/2018 Near Surface Precipitation Rate', size = 20)
...
plt.title('GPM Overpass 3/8/2018 LWP/IWP Ratio', size = 20)
...
plt.title('GPM Overpass 3/8/2018 IWP', size = 20)
...
plt.title('GPM Overpass 3/8/2018 Precipitation Category', size = 20)
label = 'KBOX'
x2star,y2star = m(-71.137,41.956)
m.plot(x2star,y2star,'ro',markersize=12, color = 'k')
plt.text(x2star-0.4,y2star+0.15,label, weight = 'bold', size = 10)
...
plt.title('GPM Overpass 3/8/2018 Snowfall Rate (KuPR)', size = 20)
label = 'KBOX'
x2star,y2star = m(-71.137,41.956)
m.plot(x2star,y2star,'ro',markersize=12, color = 'k')
plt.text(x2star-0.4,y2star+0.15,label, weight = 'bold', size = 10)
...
plt.title('GPM Overpass 3/8/2018 Snowfall Rate (KaPR)', size = 20)
label = 'KBOX'
x2star,y2star = m(-71.137,41.956)
m.plot(x2star,y2star,'ro',markersize=12, color = 'k')
plt.text(x2star-0.4,y2star+0.15,label, weight = 'bold', size = 10)
