...
file_zh = 'KENX_N0R_20180308_144800_Zh.nc'
file_zdr = 'KENX_N0X_20180308_144800_Zdr.nc'
...
xlim = np.array([-76,-71]); ylim = np.array([41.5,45])
...
plt.title(r'KENX 3/8 1448 UTC $Z_{H}$', size = title_font_size)
plt.show()
...
plt.title(r'KENX 3/8 1448 UTC $Z_{DR}$', size = title_font_size)
plt.show()
